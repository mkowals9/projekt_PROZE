...
/** Class representing bot-slowing power-up on map */
public class BotSlowPowerUpBlock extends Block {

    public BotSlowPowerUpBlock(int posX, int posY, int maxX, int maxY) {
    ...
    public void resizeStroke() {
        ...
        Image image = UIManager.getInstance().getImageManager().getBotSlowPowerUp();
        if (image != null) {
        ...
        appState.getCurrentGame().setBotSpeed(appState.getGameMode().getBotSpeed() / 2);
